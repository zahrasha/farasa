    ...
    <div class="container">
        <div class="row margin-bottom-0">
            ...
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title "><i class="mdi-action-home"></i> صفحه اصلی /دوره انتخابی/اعتبار و پرداخت/آرشیو پرداخت</h5>
            </div>
        </div>
        <div class="row">
        ...
        <table class="col s12 m8 l8 offset-l2 responsive-table striped centered farzan-table  first-col-shrink">
                ...
                <tr>
                   ...
                   <td>1396/08/08</td>
                   <td>18372</td>
                   <td>پايش پژوهش های بالينی (Monitoring)</td>
                   <td>200,000</td>
                   <td>آنلاین</td>
                   <td>تایید</td>
                   <td></td>
