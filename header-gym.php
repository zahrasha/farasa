        ...
        <nav class="white hide-on-med-and-down my-nav">
            ...
            <div class="nav-wrapper">
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a class="black-text waves-effect waves-teal" href="#">
...
<nav class="hide-on-large-only mobile-nav">
    <div class="nav-wrapper white">
        ...
        <ul class="side-nav collapsible collapsible-accordion" id="mobile-demo">
            ...
            <li class="active">
                    <a href="#" class="collapsible-header remove-arrow waves-effect waves-cyan">
                    <i class="mdi-action-home right"></i> صفحه اصلی
                    </a>
                </li>
            <li>
            ...
            <!--            ===================items===========-->
            <li>
                <a class="collapsible-header remove-arrow  waves-effect waves-teal">
            ...
            <li>
                <a class="collapsible-header remove-arrow  waves-effect waves-teal">
                    <i class="mdi-action-account-balance-wallet right"></i>
                    گزارش مالی
                </a>
            </li>
            <li>
            ...
            <li>
                <a class="collapsible-header remove-arrow waves-effect waves-teal">
                    <i class="mdi-action-class right"></i>
                    مدیریت کلاسها    
                </a>
            </li>
