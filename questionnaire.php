...
<div class="row">
    <div class="col s12 m12 l10 offset-l1 card">
        <p> آزمون نهایی</p>
                ...
                <label for="choice_279_0"></label><span>معیار شایستگی برای شرکت کنندگان</span>
		        <li >
                ...
                <label for="choice_279_3"></label> <span>فرضیات مطالعه</span>
		        <li >
		        <input type="radio" name="answers[279]" value="-1" id="choice_279'_x" checked="checked" />
                <label for="choice_279'_x"></label> <span><em>بدون پاسخ</em></span>
	            </li>
                </ul>    
